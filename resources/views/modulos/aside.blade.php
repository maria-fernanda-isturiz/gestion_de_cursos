<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        ...
        <span class="app-brand-text demo menu-text fw-bold ms-2">Gestion</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    ...
                    <div data-i18n="Without menu">Cursos Activos</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="layouts-without-navbar.html" class="menu-link">
                    <div data-i18n="Without navbar">Cursos Inactivos</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link">
                ...
                <div data-i18n="Dashboards">Instructores</div>
            </a>
        </li>
